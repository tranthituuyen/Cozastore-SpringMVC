...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, 'ao-khoac', 'Áo khoác', '2021-03-06 19:57:28', 'tú uyên', NULL, NULL);
INSERT INTO `category` VALUES (2, 'ao-thun', 'Áo thun', '2021-03-06 19:58:47', 'tú uyên', NULL, NULL);
INSERT INTO `category` VALUES (3, 'so-mi', 'Sơ mi', '2021-03-06 19:58:47', 'tú uyên', NULL, NULL);
...
CREATE TABLE `product`  (
  ...
  CONSTRAINT `product_fk_category_code` FOREIGN KEY (`category_code`) REFERENCES `category` (`code`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, 'collar-shirt', 'Áo Sơ Mi Nam SSSTUTTER Collar Shirt', 'so-mi', 419000, 'CollarShirt_cover.jpg', 'nam', '<p>Chất liệu: Vải Bamboo kh&ocirc;ng g&acirc;y hại đến m&ocirc;i trường. Chống nhăn, thấm h&uacute;t vượt trội hơn chất liệu cotton th&ocirc;ng thường đến 60%.</p>\n\n<p>Kiểu d&aacute;ng: Loại sơ mi cổ đức đơn giản nhưng kh&ocirc;ng bao giờ sợ bị lỗi mốt.</p>\n\n<p>M&agrave;u sắc: Hai m&agrave;u Đen/Trắng - tone m&agrave;u ph&ugrave; hợp với mọi tone da. Ứng dụng đa dạng cho mọi phong c&aacute;ch, mọi ho&agrave;n cảnh.</p>\n', '', b'1', '2021-01-08 13:09:46', 'Tú Uyên', NULL, NULL);
INSERT INTO `product` VALUES (2, 'man-shirt', 'Áo Sơ Mi Nam SSSTUTTER Man Shirt', 'so-mi', 419000, 'man-shirt-cover', 'nam', NULL, NULL, b'1', '2021-03-11 11:49:00', 'tú uyên', NULL, NULL);
INSERT INTO `product` VALUES (4, 'thomas-jacket', 'Áo Khoác Nam SSSTUTTER SSS. Thomas Jacket', 'ao-khoac', 799000, 'thomas-jacket-cover', 'nam', NULL, NULL, b'1', '2021-03-11 11:50:47', 'tú uyên', NULL, NULL);
INSERT INTO `product` VALUES (5, 'win-coat', 'Áo Khoác Dài Măng Tô Nam SSSTUTTER Win Coat 2020', 'ao-khoac', 999000, 'win-coat-cover', 'nam', NULL, NULL, b'1', '2021-03-11 11:51:48', 'tú uyên', NULL, NULL);
INSERT INTO `product` VALUES (6, 'dayday-long-tee', 'Áo Thun Unisex Dài Tay SSSTUTTER Dayday Long Tee', 'ao-thun', 199000, 'win-coat-cover', 'nam', NULL, NULL, b'1', '2021-03-11 11:53:26', 'tú uyên', NULL, NULL);
...
CREATE TABLE `product_detail`  (
  ...
  CONSTRAINT `product_detail_fk_product_code` FOREIGN KEY (`product_code`) REFERENCES `product` (`code`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `product_image`  (
  ...
  CONSTRAINT `image_fk_product_code` FOREIGN KEY (`product_code`) REFERENCES `product` (`code`) ON DELETE RESTRICT ON UPDATE RESTRICT
